...
class DBConnection 
{
    ...
    public function insertReservetion($room_id, $user_id, $start_date, $end_date) 
    {
    ...
    public function run() {
        if (isset($_GET['action']) && !empty($_GET['action'])) {
            switch ($_GET['action']) 
            {
                ...
                case 'deleteReservetion':
                    session_start();   
                    $id = $_GET['id'];
                    $result = $this->deleteReservetion($id);
                    $this->show($result);
                    break;
                ...
                case 'insertReservetion':
                    ...
                    $result = $this->insertReservetion($room_id, $user_id, $start_date, $end_date);
                    $this->show($result);
                    break;
                    
                case 'editReservetion':
                    session_start(); 
                    $start_date = $_GET['start_date'];
                    $end_date = $_GET['end_date']; 
                    $id = $_GET['id']; 
                    $result = $this->editReservetion($id, $start_date, $end_date);
                    $this->show($result);
                    break;
                }
        }
