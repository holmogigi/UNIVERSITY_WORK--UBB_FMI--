...
void test_elementsWithMaximumFrequency()
{
    cout<<"Test extra operation"<<'\n';
    ...
    assert(b.elementsWithMaximumFrequency()==3);

    b.add(5);
    assert(b.elementsWithMaximumFrequency()==1);
}
...
void testAllExtended()
{
	...
	testRemove();
	testIterator();
    test_elementsWithMaximumFrequency();
    testQuantity();
}
